// I *think* this fuzz test should fail: without adding y-slop, errors
// in solving curves for y position should allow ordering cycles.
// But I haven't actually seen it fail yet...
#![no_main]
...
fuzz_target!(|data: &[u8]| {
    ...
    let cmp01 = intersect_cubics(c0, c1, eps, eps / 2.0);
    let cmp02 = intersect_cubics(c0, c2, eps, eps / 2.0);
    let cmp12 = intersect_cubics(c1, c2, eps, eps / 2.0);
